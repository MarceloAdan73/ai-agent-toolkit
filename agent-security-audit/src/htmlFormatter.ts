...
export function generateHtmlReport(entries: AuditEntry[], agentName: string): string {
...
<body>
  <div class="container">
    <header>
      <h1>${agentName}</h1>
      <p class="meta">Generado: ${new Date().toLocaleString('es-AR')} • Archivos auditados: ${entries.length}</p>
    </header>
    <div class="summary">
