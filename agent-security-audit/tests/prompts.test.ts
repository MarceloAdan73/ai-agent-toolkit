...
describe('prompts', () => {
  describe('SYSTEM_PROMPT', () => {
    ...
    it('mentions OWASP categories', () => {
      expect(SYSTEM_PROMPT).toContain('SQL Injection');
      expect(SYSTEM_PROMPT).toContain('XSS');
      expect(SYSTEM_PROMPT).toContain('Secrets');
      expect(SYSTEM_PROMPT).toContain('Path Traversal');
      expect(SYSTEM_PROMPT).toContain('Authentication');
      expect(SYSTEM_PROMPT).toContain('CSRF');
    });
