...
Genera documentación JSDoc automática usando IA.

## Instalación

```bash
# Global
npm install -g @aiagentkit/agent-doc-generator
...
```bash
agent-doc-generator --path ./src                        # documentación de todo src/
agent-doc-generator --path ./src/utils.ts               # un solo archivo
agent-doc-generator --path ./src --split                # un DOCS.md por archivo
agent-doc-generator --path ./src --format html          # salida HTML
agent-doc-generator --path ./src --extensions .ts,.prisma  # solo archivos .ts y .prisma
agent-doc-generator --path ./src --dry-run              # preview sin escribir
agent-doc-generator --path ./src --verbose              # logs detallados
```
...
- **Modo single** (default): genera un único `DOCS.md`
- **Modo split** (`--split`): genera `.docs.md` por cada fuente
